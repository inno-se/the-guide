...
### Generalized feedback cycle

> [!NOTE]
> This section was generated by Gemini 2.5 Pro with Grounding with Google Search enabled.
>
> It was revised manually.

This cycle is designed to create a clear, respectful, and productive exchange that ensures feedback is understood, valued, and acted upon.

#### Phase 1: Getting ready

Before you even ask for feedback, do these three things first.

1. **Know Your Goal**
    - **What to do:** Be clear about *why* you want feedback and what you want feedback *on*.
    - **Why it helps:** This focuses the conversation and makes sure everyone is on the same page.

2. **Show the Thing**
    - **What to do:** Present the actual item you're discussing - the document, the code, the demo, or the problem.
    - **Why it helps:** People need to see exactly what you're talking about to give good, specific advice.

3. **Share What You Changed (If you've asked before)**
    - **What to do:** Briefly mention how you used their last suggestions. ("Last time, you said the text was hard to read, so I made it bigger.")
    - **Why it helps:** This shows you actually listen, which makes people want to help you again.

#### Phase 2: The conversation

This is how to handle the actual feedback exchange in a clear and respectful way.

4. **Ask Good Questions**
    - **What to do:** Don't just ask, "What do you think?" Ask specific questions that require more than a "yes" or "no." For example: "Where did this get confusing for you?" or "What's one thing that could be better?"
    - **Why it helps:** This gets you useful details instead of vague opinions like "it's fine."

5. **Just Listen and Write It Down**
    - **What to do:** Your goal is to understand, not to argue or defend your work. Quietly listen and take notes.
    - **Why it helps:** If you get defensive, people will stop giving you honest feedback.

6. **Repeat What You Heard**
    - **What to do:** To make sure you got it right, say the feedback back to them in your own words. ("Okay, so you're saying the button should be green instead of blue. Is that correct?")
    - **Why it helps:** This prevents misunderstandings and makes sure you don't fix the wrong problem.

#### Phase 3: Addressing feedback

Feedback is useless if you don't do anything with it. This is how you finish the process.

7. **Review and Decide What's Most Important**
    - **What to do:** Look at all the feedback you received. Find the most important points or common themes. You likely can't do everything, so pick what matters most.
    - **Why it helps:** This helps you focus your energy on the changes that will make the biggest difference.

8. **Make a To-Do List**
    - **What to do:** Turn the feedback you've chosen into a list of actionable tasks with testable acceptance criteria. Assign these tasks and set deadlines.
    - **Why it helps:** A plan turns good ideas into real, concrete actions.

9. **Do the Work**
    - **What to do:** Follow your plan and make the changes.
    - **Why it helps:** This is the whole point of getting feedback - to make things better.
